...
int main(int argc, char **args) {
   ...
   if (output_file != NULL) {
      ...
      if (encryption_result->length > 256) {
         printf("Printing first 256 bytes of result, saving everything to c-dec\n\n\tCiphertext (in cleartext): ");
         write_file_bytes(encryption_result->result, encryption_result->length, "c-dec");
